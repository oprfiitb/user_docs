Compute Node 3
--------------
Model: S8247-21L (aka S812L)
(CPU-CAPI-Resource)

1. CPU: IBM POWER8 Processor 3.75 GHz 10 Core CPU (8 threads/core)
...
2. RAM: 128 GB of RAM
3. FPGA: 1 X AlphaData CAPI FPGA Card

http://www.alpha-data.com/dcp/capi.php
